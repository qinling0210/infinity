...
def generate(generate_if_exists: bool, copy_dir: str):
    ...
    with open(import_slt_path, "w") as slt_file:
        ...
        slt_file.write("statement ok\n")
        slt_file.write(
            f"CREATE TABLE {table_name} (c1 INT, c2 MULTIVECTOR(INT, {dim}));\n"
        )
        slt_file.write("\n")
        ...
        slt_file.write("statement ok\n")
        slt_file.write(
            f"CREATE TABLE {table_name1} (c1 INT, c2 MULTIVECTOR(INT, {dim}));\n"
        )
        slt_file.write("\n")
        ...
        slt_file.write("statement ok\n")
        slt_file.write(
            f"CREATE TABLE {table_name_err} (c1 INT, c2 MULTIVECTOR(INT, {dim + 1}));\n"
        )
        slt_file.write("\n")
